 ...
 *
 * embed_width        Width of the embed, in px
 * embed_height       Height of the embed, in px
 */
?>
<div class="calameo-book-embed">
  <iframe
    src="//v.calameo.com/?bkcode=<?php print $ID; ?><?php if (!empty($AuthID )) print "&authid={$AuthID}"; ?>"
    width="<?php print $embed_width; ?>"
    height="<?php print $embed_height; ?>"
    frameborder="0"
    scrolling="no"
    allowtransparency
    allowfullscreen
